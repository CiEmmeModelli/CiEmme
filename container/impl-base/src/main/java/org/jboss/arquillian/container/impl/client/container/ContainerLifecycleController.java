...
public class ContainerLifecycleController {
    ...
    public void setupContainer(@Observes SetupContainer event) throws ExceptionSetContainer {
        try {
    ...
    public void stopContainer(@Observes StopContainer event) throws ExceptionSetContainer {
        try {
            forContainer(event.getContainer(), new Operation<Container>() {
                @Override
                public void perform(Container container) throws Exception {
    ...
    public void killContainer(@Observes KillContainer event) throws ExceptionSetContainer {
        try {
            forContainer(event.getContainer(), new Operation<Container>() {
                @Override
                public void perform(Container container) throws Exception {
