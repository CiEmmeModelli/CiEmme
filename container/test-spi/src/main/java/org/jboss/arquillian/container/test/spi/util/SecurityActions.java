...
final class SecurityActions {
    ...
    private static String messageUncheckedExc = "Obtained unchecked Exception; this code should never be reached";
    ...
    static Class<?> loadClass(String className) {
        try {
            ...
            try {
                ...
                throw new MyCustomException("Could not load class " + className, e2);
            }
        }
    }
    ...
    static <T> T newInstance(final String className, final Class<?>[] argumentTypes, final Object[] arguments,
        ...
        if (!expectedType.isAssignableFrom(implClass)) {
            throw new MyCustomException("Loaded class " + className + " is not of expected type " + expectedType);
        }
    ...
    static <T> T newInstance(final String className, final Class<?>[] argumentTypes, final Object[] arguments,
        ...
        try {
            ...
            throw new MyCustomException("Could not load class " + className, e);
        }
    ...
    static <T> T newInstance(final Class<T> implClass, final Class<?>[] argumentTypes, final Object[] arguments) {
        ...
        try {
            ...
            throw new MyCustomException("Could not create new instance of " + implClass, e);
        }
