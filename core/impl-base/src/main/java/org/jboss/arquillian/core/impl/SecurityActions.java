...
final class SecurityActions {
    ...
    static Class<?> loadClass(String className) {
        try {
            ...
            try {
                ...
                throw new LoadException("Could not load class " + className, e2);
            }
        }
    }
    ...
    static <T> T newInstance(final String className, final Class<?>[] argumentTypes, final Object[] arguments,
        ...
        if (!expectedType.isAssignableFrom(implClass)) {
            throw new LoadException("Loaded class " + className + " is not of expected type " + expectedType);
        }
    ...
    static <T> T newInstance(final String className, final Class<?>[] argumentTypes, final Object[] arguments,
        ...
        try {
            ...
            throw new LoadException("Could not load class " + className, e);
        }
        Object obj = newInstance(clazz, argumentTypes, arguments);
        try {
            return expectedType.cast(obj);
        } catch (Exception e) {
            throw new LoadException("Loaded class " + className + " is not of expected type " + expectedType, e);
        }
    }
    ...
    static <T> T newInstance(final Class<T> implClass, final Class<?>[] argumentTypes, final Object[] arguments) {
        ...
        try {
            ...
            throw new LoadException("Could not create new instance of " + implClass, e);
        }
