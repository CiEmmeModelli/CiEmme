...
final class SecurityActions {
    ...
    private static String errMessage = "Obtained unchecked Exception; this code should never be reached";
    ...
    static Class<?> loadClass(String className) {
        try {
            ...
            try {
                ...
                throw new MyCustomExceptionForSec("Could not load class " + className, e2);
            }
        }
    }
    ...
    static <T> T newInstance(final String className, final Class<?>[] argumentTypes, final Object[] arguments,
        ...
        if (!expectedType.isAssignableFrom(implClass)) {
            throw new MyCustomExceptionForSec("Loaded class " + className + " is not of expected type " + expectedType);
        }
    ...
    static <T> T newInstance(final String className, final Class<?>[] argumentTypes, final Object[] arguments,
        ...
        try {
            ...
            throw new MyCustomExceptionForSec("Could not load class " + className, e);
        }
        Object obj = newInstance(clazz, argumentTypes, arguments);
        try {
            return expectedType.cast(obj);
        } catch (Exception e) {
            throw new MyCustomExceptionForSec("Loaded class " + className + " is not of expected type " + expectedType, e);
        }
    }
    ...
    static <T> T newInstance(final Class<T> implClass, final Class<?>[] argumentTypes, final Object[] arguments) {
        ...
        try {
            ...
            throw new MyCustomExceptionForSec("Could not create new instance of " + implClass, e);
        }
    ...
    public static void setFieldValue(final Class<?> source, final Object target, final String fieldName,
        ...
        // Unwrap
            ...
            if (t instanceof NoSuchFieldException) {
                ...
                // No other checked Exception thrown by Class.getConstructor
                try {
                    throw (MyCustomExceptionForSec) t;
                }
                // Just in case we've really messed up
                catch (final ClassCastException cce) {
                    throw new MyCustomExceptionForSec(errMessage, t);
