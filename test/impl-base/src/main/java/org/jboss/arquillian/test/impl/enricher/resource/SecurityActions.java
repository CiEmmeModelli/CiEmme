...
final class SecurityActions {
    ...
    private static final String UNCHK_STRING="Obtained unchecked Exception; this code should never be reached"; 
    //-------------------------------------------------------------------------------||
    // Constructor ------------------------------------------------------------------||
    //-------------------------------------------------------------------------------||
    ...
    static Class<?> loadClass(String className) {
        try {
            ...
            try {
                ...
                throw new LoadClassException("Could not load class " + className, e2);
            }
        }
    }
    ...
    static <T> T newInstance(final String className, final Class<?>[] argumentTypes, final Object[] arguments,
        ...
        if (!expectedType.isAssignableFrom(implClass)) {
            throw new LoadClassException("Loaded class " + className + " is not of expected type " + expectedType);
        }
    ...
    static <T> T newInstance(final String className, final Class<?>[] argumentTypes, final Object[] arguments,
        ...
        try {
            ...
            throw new LoadClassException("Could not load class " + className, e);
        }
        Object obj = newInstance(clazz, argumentTypes, arguments);
        try {
            return expectedType.cast(obj);
        } catch (Exception e) {
            throw new LoadClassException("Loaded class " + className + " is not of expected type " + expectedType, e);
        }
    }
    ...
    static <T> T newInstance(final Class<T> implClass, final Class<?>[] argumentTypes, final Object[] arguments) {
        ...
        try {
            ...
            throw new LoadClassException("Could not create new instance of " + implClass, e);
        }
        ...
        // Unwrap
            ...
            if (t instanceof NoSuchMethodException) {
                ...
                // Just in case we've really messed up
                    ...
                    throw new LoadClassException(UNCHK_STRING, t);
                }
            }
        }
    }
        ...
        // Unwrap
            ...
            if (t instanceof NullPointerException) {
                ...
                // Just in case we've really messed up
                    ...
                    throw new RuntimeException(UNCHK_STRING, t);
                }
            }
        }
    }
