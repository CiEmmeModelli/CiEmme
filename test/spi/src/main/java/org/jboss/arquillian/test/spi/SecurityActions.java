...
final class SecurityActions {
    private static final String EXCP_STRING="Obtained unchecked Exception; this code should never be reached";
    ...
    static Class<?> loadClass(String className) {
        try {
            ...
            try {
                ...
                throw new NotLoadException("Could not load class " + className, e2);
            }
        }
    }
    ...
    static <T> T newInstance(final String className, final Class<?>[] argumentTypes, final Object[] arguments,
        ...
        if (!expectedType.isAssignableFrom(implClass)) {
            throw new NotLoadException("Loaded class " + className + " is not of expected type " + expectedType);
        }
    ...
    static <T> T newInstance(final String className, final Class<?>[] argumentTypes, final Object[] arguments,
        ...
        try {
            ...
            throw new NotLoadException("Could not load class " + className, e);
        }
        Object obj = newInstance(clazz, argumentTypes, arguments);
        try {
            return expectedType.cast(obj);
        } catch (Exception e) {
            throw new NotLoadException("Loaded class " + className + " is not of expected type " + expectedType, e);
        }
    }
    ...
    static <T> T newInstance(final Class<T> implClass, final Class<?>[] argumentTypes, final Object[] arguments) {
        ...
        try {
            ...
            throw new NotLoadException("Could not create new instance of " + implClass, e);
        }
        ...
        // Unwrap
            ...
            if (t instanceof NoSuchMethodException) {
                ...
                // Just in case we've really messed up
                    ...
                    throw new NotLoadException(EXCP_STRING, t);
                }
            }
        }
    }
        ...
        // Unwrap
            ...
            if (t instanceof NullPointerException) {
                ...
                // Just in case we've really messed up
                    ...
                    throw new RuntimeException(EXCP_STRING, t);
                }
            }
        }
    }
