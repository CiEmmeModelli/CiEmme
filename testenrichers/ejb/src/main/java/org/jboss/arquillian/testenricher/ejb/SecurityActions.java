...
final class SecurityActions {
    ...
    static Class<?> loadClass(String className) {
        try {
            ...
            try {
                ...
                throw new NameException("Could not load class " + className, e2);
            }
        }
    }
    ...
    static <T> T newInstance(final String className, final Class<?>[] argumentTypes, final Object[] arguments,
        ...
        if (!expectedType.isAssignableFrom(implClass)) {
            throw new NameException("Loaded class " + className + " is not of expected type " + expectedType);
        }
    ...
    static <T> T newInstance(final String className, final Class<?>[] argumentTypes, final Object[] arguments,
        ...
        try {
            ...
            throw new NameException("Loaded class " + className + " is not of expected type " + expectedType, e);
        }
    }
    ...
    static <T> T newInstance(final Class<T> implClass, final Class<?>[] argumentTypes, final Object[] arguments) {
        ...
        try {
            ...
            throw new NameException("Could not create new instance of " + implClass, e);
        }
